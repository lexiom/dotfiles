...
local c = {
  ...
  grayscale2 = "#d0d0d0", -- selection / borders
  grayscale3 = "#b0b0b0", -- non characters
  grayscale4 = "#808080", -- comments / secondary text
  grayscale5 = "#404040", -- data types / delimiters
  grayscale6 = "#000000", -- main foreground
}
...
set(0, "CursorLineNr", { fg = c.grayscale6, bg = c.bg, bold = true })
...
set(0, "Search",       { fg = c.grayscale6, bg = c.grayscale1, bold = true })
set(0, "CurSearch",    { fg = c.bg, bg = c.grayscale5 })
set(0, "IncSearch",    { fg = c.bg, bg = c.grayscale5 })
...
set(0, "MoreMsg",      { fg = c.grayscale6, bold = true })
...
set(0, "Character",  { fg = c.grayscale5 })
set(0, "Number",     { fg = c.grayscale5 })
set(0, "Boolean",    { fg = c.grayscale5, bold = true })
set(0, "Float",      { fg = c.grayscale5 })

set(0, "Identifier", { fg = c.grayscale6 })
set(0, "Function",   { fg = c.grayscale6, bold = false })

set(0, "Statement",   { fg = c.grayscale6, bold = true })
set(0, "Conditional", { fg = c.grayscale6, bold = true })
set(0, "Repeat",      { fg = c.grayscale6, bold = true })
set(0, "Label",       { fg = c.grayscale6, bold = true })
set(0, "Operator",    { fg = c.grayscale6 })
set(0, "Keyword",     { fg = c.grayscale6, bold = true })
set(0, "Exception",   { fg = c.grayscale6, bold = true })

set(0, "PreProc",    { fg = c.grayscale5, bold = true })
set(0, "Include",    { fg = c.grayscale5, bold = true })
set(0, "Define",     { fg = c.grayscale5, bold = true })
set(0, "Macro",      { fg = c.grayscale5, bold = true })

set(0, "Type",         { fg = c.grayscale6, bold = false })
set(0, "StorageClass", { fg = c.grayscale6, bold = true })
set(0, "Structure",    { fg = c.grayscale6, bold = false })
...
set(0, "Todo",       { fg = c.grayscale6, bg = c.grayscale2, bold = true })
...
set(0, "@function.call",   { fg = c.grayscale6, bold = true })
set(0, "@method",          { fg = c.grayscale6, bold = true })
set(0, "@method.call",     { fg = c.grayscale6, bold = true })
set(0, "@constructor",     { fg = c.grayscale6 })

set(0, "@keyword",          { link = "Keyword" })
set(0, "@keyword.function", { fg = c.grayscale6, bold = true })
set(0, "@conditional",      { link = "Conditional" })
set(0, "@repeat",           { link = "Repeat" })

set(0, "@type",         { link = "Type" })
set(0, "@type.builtin", { fg = c.grayscale6, bold = true })

set(0, "@variable",         { fg = c.grayscale6 })
set(0, "@variable.builtin", { fg = c.grayscale6, bold = true })

set(0, "@constant",         { link = "Constant" })
set(0, "@constant.builtin", { fg = c.grayscale6, bold = true })
...
-- LSP semantic tokens
set(0, "@lsp.type.function",  { fg = c.grayscale6, bold = true })
set(0, "@lsp.type.method",    { fg = c.grayscale6, bold = true })
set(0, "@lsp.type.class",     { fg = c.grayscale6, bold = true })
set(0, "@lsp.type.struct",    { fg = c.grayscale6, bold = true })
set(0, "@lsp.type.enum",      { fg = c.grayscale6, bold = true })
set(0, "@lsp.type.interface", { fg = c.grayscale6, bold = true })
