...
vim.g.colors_name = "parchment-light"
...
local c = {
  ...
  parchment3 = "#b4aaa0", -- non characters
  parchment4 = "#8f7654", -- comments / secondary text
  parchment5 = "#76562f", -- muted brown foreground
  parchment6 = "#3a2818", -- strong brown foreground
}

-- UI
set(0, "Normal",       { fg = c.fg, bg = c.bg })
set(0, "NormalFloat",  { fg = c.fg, bg = c.parchment1 })
set(0, "FloatBorder",  { fg = c.parchment4, bg = c.parchment1 })

set(0, "Cursor",       { fg = c.bg, bg = c.fg })
set(0, "CursorLine",   { bg = c.parchment1 })
set(0, "CursorColumn", { bg = c.parchment1 })

set(0, "LineNr",       { fg = c.parchment4, bg = c.bg })
set(0, "CursorLineNr", { fg = c.fg, bg = c.parchment1, bold = true })

set(0, "SignColumn",   { fg = c.parchment4, bg = c.bg })
set(0, "FoldColumn",   { fg = c.parchment4, bg = c.bg })
...
set(0, "StatusLineNC", { fg = c.parchment5, bg = c.parchment1 })
...
set(0, "PmenuThumb",   { bg = c.parchment5 })

set(0, "TabLine",      { fg = c.parchment5, bg = c.parchment1 })
...
set(0, "Whitespace", { fg = c.parchment3 })
set(0, "EndOfBuffer", { fg = c.parchment3 })

-- Diagnostics
-- Still monochromatic: severity is expressed by weight/underline, not hue.
set(0, "DiagnosticError", { fg = c.fg, bold = true })
set(0, "DiagnosticWarn",  { fg = c.parchment6, bold = true })
set(0, "DiagnosticInfo",  { fg = c.parchment5 })
set(0, "DiagnosticHint",  { fg = c.parchment4 })
...
-- Syntax
set(0, "Comment",    { fg = c.parchment4, italic = true })

set(0, "Constant",   { fg = c.parchment6 })
set(0, "String",     { fg = c.parchment6 })
set(0, "Character",  { fg = c.parchment6 })
set(0, "Number",     { fg = c.parchment6 })
set(0, "Boolean",    { fg = c.fg, bold = true })
set(0, "Float",      { fg = c.parchment6 })
...
set(0, "PreProc",    { fg = c.parchment6, bold = true })
set(0, "Include",    { fg = c.parchment6, bold = true })
set(0, "Define",     { fg = c.parchment6, bold = true })
set(0, "Macro",      { fg = c.parchment6, bold = true })
...
set(0, "Special",     { fg = c.parchment5 })
set(0, "SpecialChar", { fg = c.parchment5 })
set(0, "Delimiter",   { fg = c.parchment6 })
...
set(0, "DiffDelete", { fg = c.parchment4, bg = c.parchment1 })
set(0, "DiffText",   { fg = c.fg, bg = c.parchment2, bold = true })

-- Git signs
set(0, "GitSignsAdd",    { fg = c.parchment5 })
set(0, "GitSignsChange", { fg = c.parchment5 })
set(0, "GitSignsDelete", { fg = c.parchment5 })
...
set(0, "@punctuation", { fg = c.parchment6 })
set(0, "@punctuation.delimiter", { fg = c.parchment6 })
...
set(0, "@lsp.type.comment",   { fg = c.parchment4, italic = true })
